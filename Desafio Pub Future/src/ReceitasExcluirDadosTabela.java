...
public class ReceitasExcluirDadosTabela {

	/**
	 * Método para excluir uma linha de receitas da tabela receitas, onde o usuário
	...
	public static void main(String[] args) throws SQLException {
		...
		String SQL = "delete for receitas where seq = ?";
